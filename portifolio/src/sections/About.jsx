    ...
    <section id="about" className="py-24 px-6 bg-gray-50">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 mt-3">Get to know me better</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
            ...
            <p className="text-gray-600 leading-7">
              I’m Kabe Gutema, a Full Stack Developer focused on building modern
              web applications using the MERN stack. I enjoy turning ideas into
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
            <div className="flex items-center gap-3 mb-4 text-gray-900">
              ...
              <h3 className="text-xl font-semibold">Education & Mindset</h3>
            </div>
